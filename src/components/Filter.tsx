    ...
    return (
        <div className="mt-12 flex justify-between">
            <div className="flex gap-6 flex-wrap">
                ...
                <select name="size" id="" className="py-2 px-4 rounded-2xl text-xs font-medium bg-gray-100">
                    <option>Size</option>
                    <option value="">Size</option>
                </select>
                <select name="color" id="" className="py-2 px-4 rounded-2xl text-xs font-medium bg-gray-100">
                    <option>Color</option>
